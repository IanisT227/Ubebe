...
class UI:
    ...
    def logToFile(self, solutionAverages, lastSeed=30, populationSize=20, individualSize=30, generationCount=30,
                  numberIterations=50):
    ...
    def runEA(self):
        while True:
            ...
            if eaOption == "1":
                ...
                bestIndividuals, averages = self.__controller.solver(int(self.__popSize), int(self.__indSize), int(self.__genCount), int(self.__nrIterations))
