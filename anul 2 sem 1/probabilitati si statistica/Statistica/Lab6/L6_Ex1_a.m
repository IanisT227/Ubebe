pkg load statistics;  clc;  clear all;
...
sigma=5;    % theoretical standard deviation 
m_0=9;      % hypothesis

% H0: mean = 9                     (the mean is at least 9)
% H1: mean < 9  (left-tailed test) (the mean is less than 9)
